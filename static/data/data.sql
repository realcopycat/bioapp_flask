...
values (0, 100, '系统管理', 'ums:permission', 'menu', null, 'layui-icon layui-icon-set-fill', null, 2, null, 0),
       (0, 100001, '权限管理', 'ums:permission:list', 'path', '/permission', '', null, 0, null, 100),
       (0, 1000011, '新增权限', 'ums:permission:create', 'auth', '', '', null, 0, null, 100001),
       (0, 1000012, '修改权限', 'ums:permission:update', 'auth', '', '', null, 0, null, 100001),
       (0, 1000013, '获取权限', 'ums:permission:read', 'auth', '', '', null, 0, null, 100001),
       (0, 1000014, '删除权限', 'ums:permission:delete', 'auth', '', '', null, 0, null, 100001),
       (0, 100002, '角色管理', 'ums:role', 'path', '/role', '', null, 0, null, 100),
       (0, 1000021, '新增角色', 'ums:role:create', 'auth', '', '', null, 0, null, 100002),
       (0, 1000022, '修改角色', 'ums:role:update', 'auth', '', '', null, 0, null, 100002),
       (0, 1000023, '查询角色', 'ums:role:read', 'auth', '', '', null, 0, null, 100002),
       (0, 1000024, '删除角色', 'ums:role:delete', 'auth', '', '', null, 0, null, 100002),
       (0, 100003, '部门管理', 'ums:department', 'path', '/department', '', null, 0, null, 100),
       (0, 1000031, '新建部门', 'ums:department:create', 'auth', '', '', null, 0, null, 100003),
       (0, 1000032, '修改部门', 'ums:department:update', 'auth', '', '', null, 0, null, 100003),
       (0, 1000033, '删除部门', 'ums:department:delete', 'auth', '', '', null, 0, null, 100003),
       (0, 1000034, '查询部门', 'ums:department:read', 'auth', '', '', null, 0, null, 100003),
       (0, 100004, '员工管理', 'ums:user', 'path', '/user', '', null, 0, null, 100),
       (0, 1000041, '新增员工', 'ums:user:create', 'auth', '', '', null, 0, null, 100004),
       (0, 1000042, '修改员工', 'ums:user:update', 'auth', '', '', null, 0, null, 100004),
       (0, 1000043, '查询员工', 'ums:user:read', 'auth', '', '', null, 0, null, 100004),
       (0, 1000044, '查询员工', 'ums:user:read', 'auth', '', '', null, 0, null, 100004),
